...
for (data.exp in data.experiments) {
  print(paste('Starting preliminary calibration for experiment ',data.exp,'/',n.experiment,' -- ', nnode_mcmc,' cores x ',niter_mcmc,' iterations)...', sep=''))
  tbeg=proc.time()
...
for (data.exp in data.experiments) {
  print(paste('Starting production calibration for experiment ',data.exp,'/',n.experiment,' -- ', nnode_mcmc,' cores x ',niter_mcmc,' iterations)...', sep=''))
